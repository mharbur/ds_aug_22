...
# set.seed(112020)
# saveGIF(
#   kmeans.ani(km_animation_data, centers=3, pch = c(19,19,19), col = c("darkgreen", "blue", "red3")),
...
![](data-unit-13/cluster_frames/frame_01_delay-1s.jpg)
...
classes = cut(x$corn, breaks=c(-Inf, 100, 120, 140, Inf),
              labels = c("0-100 bu/A", "100-120 bu/A", "120-140 bu/A", "140+ bu/A"))
...
y = testData %>%
  ...
  knn.ani(train = x_final, test = y, cl=classes, k = 5, cl.pch = c(15,16,17,18), knn.col = "black")
...
![](data-unit-13/knn_frames/frame_01_delay-1s.jpg)
