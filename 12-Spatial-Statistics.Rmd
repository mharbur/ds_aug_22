...
# webshot("temp.html", file = "data-unit-12/images/wgs_84.png",
#         cliprect = "viewport")
...
#
saveRDS(complete_soil_data, "data-unit-12/complete_soil_data.Rds")
```


Here is a SSURGO map of soil organic matter.
```{r echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE}
complete_soil_data <- readRDS("data-unit-12/complete_soil_data.Rds")
```
...
1) Krige the data and extract the predicted (or interpolated) values.
```{r}
kriged_data = gstat::krige(formula = measure~1, selected_data, grd, model=m)
...
2) Create the map of soil K values!
```{r}
finished_data %>%
  leaflet() %>%
  addTiles() %>%
